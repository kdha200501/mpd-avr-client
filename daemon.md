...
[Service]
ExecStart=/usr/local/bin/mpd-avr-client -v 38 -t "tx 15:44:69:09" -T 48 -b /home/pi/.mpd-avr-client/bravia-launch-profile.json -g /home/pi/.mpd-avr-client/govee-launch-profile.json
Restart=always
User=root
